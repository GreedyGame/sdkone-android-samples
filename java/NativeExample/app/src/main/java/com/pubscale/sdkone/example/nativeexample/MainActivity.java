package com.pubscale.sdkone.example.nativeexample;
...
import com.pubscale.sdkone.example.nativeexample.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadNativeAd() {
        ...
        binding.adView.setUnitId("float-13582"); //Your Ad Unit ID here
        binding.adView.setAdsMaxHeight((int) dpToPx(this, 300)); //Value is in pixels, not in dp
